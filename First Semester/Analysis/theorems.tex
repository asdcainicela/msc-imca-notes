...
% Corollary% Corollary modificado para permitir referencias
...
\NewDocumentCommand{\corp}{m+m+m}{  % titulo + enunciado + prueba
	\begin{mycorollary}{#1}{}
		#2
	\end{mycorollary}
	\begin{corpf}
...
\NewDocumentCommand{\corrp}{mm+m+m}{  % titulo + label + enunciado + prueba
	\begin{mycorollary}{#1}{#2}
		#3
	\end{mycorollary}
	\begin{corpf}
